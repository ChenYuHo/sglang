...
def _fused_gather_to_staging_kernel(
    ...
    if ALIGNED_16:
        ...
        # `_can_use_aligned_staging_copy` proved every term of both row bases; the
        # asserts cover the two index terms added to them below.
...
def _kv_buffers_preserve_16_byte_alignment(
...
def _can_use_aligned_staging_copy(
    ...
    *,
    ...
    ``buffers_aligned_16``; request-dependent terms are always checked here. One
    failed term keeps the whole launch on the generic path.
    """
